					...
					<div class="nav-collapse collapse">
						<nav id="dropdown">
							<ul class="sf-menu clearfix nav">								
                                ...
                                <li><a href="#service" class="trigger"><span>Plan & Pricing</span></a></li>								
								<li><a href="#create" class="trigger"><span>Create</span></a></li>
                                <li><a href="http://icoinhost.com:2750/"><span>Blockchain</span></a></li>
...
<!-- Start Product block --> 
<section id="service" class="anchor_holder">	 

<div class="coop_wrapper">	
    <div class="coop_control_wrapper">		
	     <div class="main_title_wrapper">		
			  <div class="block_tile_wrapper">	 
			   <h1 class="block_tile_1 color_black">Plan & Pricing</h1>
			  </div>		 
			<div class="clear"></div>		
		 </div>
